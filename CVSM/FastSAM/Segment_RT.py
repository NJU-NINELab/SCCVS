...
if __name__ == "__main__":
    # export ONNX
    # ONNX_PATH = "FastSAM-s.onnx"
    # TRT_ENGINE_PATH = "FastSAM-s.trt"
    # segmodel = FastSAM("FastSAM-s.pt")
    # IMAGE_SIZE = 640
    # export_onnx(example_shape=(1, 3, IMAGE_SIZE, IMAGE_SIZE), opset=12)
    # trtexec --onnx=FastSAM-s.onnx --saveEngine=FastSAM-s.trt --fp16

    engine_path = "FastSAM-s.trt"
